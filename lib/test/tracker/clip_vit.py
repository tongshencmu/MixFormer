...
import cv2
import os
from lib.models.clip_vit import build_clip_vit
from lib.test.tracker.tracker_utils import Preprocessor_wo_mask
from lib.utils.box_ops import clip_box


class CLIPViT(BaseTracker):
    def __init__(self, params, dataset_name):
        super(CLIPViT, self).__init__(params)
        network = build_clip_vit(params.cfg, train=False)
