...
"""
Add default config for CLIP-ViT.
"""
cfg = edict()
...
# Text Encoder
cfg.TEXT = edict()
cfg.TEXT.VIT_TYPE = 'base'
cfg.TEXT.CONTEXT_LENGTH = 77
cfg.TEXT.EMBED_DIM = 512
cfg.TEXT.NUM_LAYERS = 12
cfg.TEXT.NUM_HEADS = 8
cfg.TEXT.EMBED_CLS = False
cfg.TEXT.VOCAB_SIZE = 49408
cfg.TEXT.PRETRAINED = True
cfg.TEXT.PRETRAINED_PATH = ''
