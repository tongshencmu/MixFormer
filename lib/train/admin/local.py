class EnvironmentSettings:
    def __init__(self):
        self.workspace_dir = '/ocean/projects/ele220002p/tongshen/code/vl_tracking/MixFormer/work_dirs'    # Base directory for saving network checkpoints.
        self.tensorboard_dir = '/ocean/projects/ele220002p/tongshen/code/vl_tracking/MixFormer/work_dirs/tensorboard'    # Directory for tensorboard files.
        self.pretrained_networks = '/ocean/projects/ele220002p/tongshen/code/vl_tracking/MixFormer/work_dirs/pretrained_networks'
